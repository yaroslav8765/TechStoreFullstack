...
function AvailabilityIcon({state}){
    return<>
    {state===true? 
        <div className="flex justify-center items-center w-[110px] h-[30px] bg-green-100 rounded-xl gap-1">
            <IoIosCheckmarkCircle className="text-green-400 text-2xl" />
            <p className="text-green-400">Available</p>
        </div>
        :
        <div className="flex justify-center items-center w-[110px] h-[30px] bg-red-100 rounded-xl gap-1">
